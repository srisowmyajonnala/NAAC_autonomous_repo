  ...
  return (
    <div className="c32-inputFields-mainContainer">
        ...
        <form>
          ...
          <div className="c32xx-container">
            <h1 className="c32xx-Heading-style">
              ...
              Total Grants from Government and non-governmental agencies for research projects,endowments,Chairs in the institution during last five years (INR in lakhs)
            </h1>
            ...
            <table className="c32x-table-style">
              <tr>
                <th className="c32x-verticalTable-heading1-style">
                  File Description
                </th>
                <th className="c32x-verticalTable-heading2-style">
                  File Template
                </th>
                <th className="c32x-verticalTable-heading3-style">
                  Documents upload
                </th>
              </tr>
              <tr>
              ...
              <tr>
                <td>e-copies of the grant award letters for research projects sponsored by non-government
                  List of project and grant details(Data)
                </td>
                <td></td>
                <td>
                  <input type="file" />
        ...
        <form>
          ...
          <div className="c32xx-container">
            <h1 className="c32xx-Heading-style">
              ...
              Number of departments having Reasearch projects funded by government agencies during the last five years
            </h1>
            ...
            <table className="c31x-table-style">
              ...
              <tr>
                <td>List of research projects and funding details(Data Template) </td>
                <td></td>
                <td>
                  <input type="file" />
                </td>
      ...
      <div className="c32x-button-container">
        <button className="c32x-button-style">Save</button>
      </div>
    </div>
