        ...
        <form>
          <div className="c33x-label-textarea-container">
            <h1 className="c33x-heading-style">
             ...
             Institution has created an eco system for innovations, creation and transfer of knowledge supported by dedicated centers for research,
             enterpreneurship,community orientation,Incubation etc.
            </h1>
        ...
        <form>
          <div className="c33x-container">
            <h1 className="c33x-heading-style">
              ...
              Number of workshops/seminars conducted on Research Methodologiy,Intellectual property Rights(IPR),
              enterpreneurship and skills development during the kast five years.
            </h1>
          </div>
          <div className="c33xx-container">
            <h1 className="c33xx-Heading-style">
              <span className="c33xx-span-style">3.3.2.1: </span>
              Total number of workshops/seminars conducted on Research Methodology,intellectual property rights(IPR) abd enterpreneurship and skills development year wise during
              last five years.
            </h1>
